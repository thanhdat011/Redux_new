...
export default function PostItem(props: PostItemProps) {
  const { post, startEdit, hanleDeletePost } = props
  return (
      ...
      <div className='flex flex-col gap-2 p-4 lg:p-6'>
        ...
        <div>
          <div className='inline-flex rounded-md shadow-sm' role='group'>
            <button
              type='button'
              className='texton-sm rounded-l-lg border border-gray-200 bg-white py-2 px-4 font-medium text-gray-900 hover:bg-gray-100 hover:text-blue-700 focus:z-10 focus:text-blue-700 focus:ring-2 focus:ring-blue-700'
